...
const SSE_ALLOWED_ORIGINS = (process.env.HEADY_CORS_ORIGINS || 'https://headyai.com,https://app.headyai.com')
...
module.exports = function mountSSEStreaming(app) {
    ...
    app.get("/api/stream/connect", (req, res) => {
        ...
        const corsOrigin = origin && SSE_ALLOWED_ORIGINS.includes(origin) ? origin : SSE_ALLOWED_ORIGINS[0];
        res.writeHead(200, {

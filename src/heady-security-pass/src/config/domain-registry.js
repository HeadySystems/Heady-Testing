...
const DOMAIN_DEFINITIONS = [
...

  {
    ...
    cors: {
      origins:     ['https://headyme.com', 'https://headysystems.com', 'https://headyai.com'],
      credentials: true,
    },
    headers: {
  ...
  {
    domain:      'headyos.com',
    aliases:     ['www.headyos.com'],
    role:        'ai_os',
    description: 'HeadyOS — AI-native operating system, core platform and process orchestration',
    service:     'headyos-service',
    upstreamPort: 3009,
    healthPath:  '/health',
    ssl:         'cloudflare',
    features:    ['ai_os', 'process_orchestration', 'kernel'],
    routing: { type: 'proxy', timeout: PHI_TIMING.CYCLE },
    tls: { mode: 'flexible', minVersion: 'TLS 1.2', hsts: true },
    rateLimit: { windowMs: 60_000, max: 100, burstMax: 200 },
    allowedMethods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
    cors: { origins: ['https://headyos.com', 'https://headyme.com'], credentials: true },
    headers: { 'X-Heady-Domain': 'headyos' },
  },

  {
    domain:      'headyconnection.org',
    aliases:     ['www.headyconnection.org', 'headyconnection.com', 'www.headyconnection.com', 'connect.headyme.com'],
    role:        'community',
    ...
    rateLimit: { windowMs: 60_000, max: 100, burstMax: 200 },
    allowedMethods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
    cors: { origins: ['https://headyconnection.org', 'https://headyconnection.com'], credentials: true },
    headers: { 'X-Heady-Domain': 'headyconnection' },
  },

  {
    domain:      'headyfinance.com',
    aliases:     ['www.headyfinance.com', 'invest.headyme.com'],
    role:        'wealth_platform',
    description: 'HeadyFinance — investment platform, portfolio management, and wealth tech',
    service:     'headyfinance-service',
    upstreamPort: 3010,
    healthPath:  '/health',
    ssl:         'cloudflare',
    features:    ['portfolio_management', 'wealth_tech', 'equity_tracking'],
    routing: { type: 'proxy', timeout: PHI_TIMING.CYCLE },
    tls: { mode: 'flexible', minVersion: 'TLS 1.2', hsts: true },
    rateLimit: { windowMs: 60_000, max: 100, burstMax: 200 },
    allowedMethods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
    cors: { origins: ['https://headyfinance.com', 'https://headyme.com'], credentials: true },
    headers: { 'X-Heady-Domain': 'headyfinance' },
  },

  {
    domain:      'headyex.com',
    aliases:     ['www.headyex.com', 'exchange.headyme.com'],
    role:        'exchange_platform',
    description: 'HeadyEx — digital asset exchange, crypto, tokens, and trading platform',
    service:     'headyex-service',
    upstreamPort: 3011,
    healthPath:  '/health',
    ssl:         'cloudflare',
    features:    ['crypto_exchange', 'trading', 'defi'],
    routing: { type: 'proxy', timeout: PHI_TIMING.CYCLE },
    tls: { mode: 'flexible', minVersion: 'TLS 1.2', hsts: true },
    rateLimit: { windowMs: 60_000, max: 100, burstMax: 200 },
    allowedMethods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
    cors: { origins: ['https://headyex.com', 'https://headyme.com'], credentials: true },
    headers: { 'X-Heady-Domain': 'headyex' },
  },

  {
    ...
    allowedMethods: ['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'OPTIONS'],
    cors: { origins: ['https://headyme.com', 'https://headysystems.com', 'https://headyai.com'], credentials: true },
    headers: {

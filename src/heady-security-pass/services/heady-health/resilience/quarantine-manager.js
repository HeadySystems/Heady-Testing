...
class QuarantineManager {
    ...
    quarantine(serviceId, reason, score) {
        ...
        // Quarantine isolation: not yet wired to MCP router or load balancer removal.
        // In production, this should remove the service from active routing.
        logger.warn('Service quarantined but isolation not yet wired to router/LB', { serviceId, reason, score });
    }

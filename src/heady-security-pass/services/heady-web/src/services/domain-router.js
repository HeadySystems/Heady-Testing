...
const DOMAIN_MAP = {
  ...
  'headyos.com': {
    ...
    projection: 'heady-os',
    deployTarget: 'cloudflare-pages',
    endpoint: 'https://headyos.com',
    stalenessBudget: 300,        // 5 minutes
    syncMode: 'event-driven',
    description: 'AI-native operating system — HeadyMe alias',
  },
  ...
  'headyconnection.org': {
    ...
    syncMode: 'event-driven',
    description: 'Vector memory federation network — canonical HeadyConnection domain',
  },
  ...
  'headyconnection.com': {
    ...
    projection: 'vector-explorer',
    deployTarget: 'huggingface-spaces',
    endpoint: 'https://headyconnection.com',
    stalenessBudget: 120,        // 2 minutes
    syncMode: 'event-driven',
    description: 'Vector memory federation network — .com alias for headyconnection.org',
  },
  ...
  'headyfinance.com': {
    ...
    deployTarget: 'cloudflare-pages',
    endpoint: 'https://headyfinance.com',
    stalenessBudget: 600,        // 10 minutes — planned vertical
    syncMode: 'event-driven',
  ...
  'admin.headysystems.com': {
    ...
    stalenessBudget: 60,         // 1 minute — admin needs freshness
    syncMode: 'event-driven',

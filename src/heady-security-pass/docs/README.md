...
## 🌐 Domain Routing and Public Sites

HeadySystems operates multiple public domains, each mapped to a specific vertical:

| Domain | Vertical | Status | Description |
|--------|----------|--------|-------------|
| `headyme.com` | headyme | Active | Primary AI OS — personal productivity |
| `headysystems.com` | headysystems | Active | Enterprise platform — B2B infrastructure |
| `headyos.com` | headyos | Active | AI-native operating system |
| `headyconnection.org` | headyconnection | Active | Community and network |
| `headyconnection.com` | headyconnection | Alias | Alias for headyconnection.org |
| `headyfinance.com` | investments | Planned | Investment and wealth platform |
| `headyex.com` | exchange | Planned | Digital asset exchange |
| `admin.headysystems.com` | headysystems | Active | Admin hub and operator dashboard |

**Routing configuration files:**
- `services/heady-web/src/services/domain-router.js` — projection routing
- `services/heady-web/template-engine/site-router.js` — vertical selection middleware
- `services/heady-web/template-engine/vertical-registry.json` — master vertical registry
- `src/config/domain-registry.js` — infrastructure-level domain definitions
- `services/heady-web/src/services/ui-registry.js` — UI micro-frontend mapping

## 📖 Runbooks

Operator runbooks for incident response and troubleshooting:

- [heady-web](runbooks/heady-web.md) — site rendering and domain health
- [heady-manager](runbooks/heady-manager.md) — API gateway and service registry
- [heady-auth](runbooks/heady-auth.md) — authentication flows
- [heady-memory](runbooks/heady-memory.md) — memory and vector services
- [public-domain-health](runbooks/public-domain-health.md) — Cloudflare and DNS triage
...
- [Quick Reference](QUICK_REFERENCE.md) — key metrics and priority actions
